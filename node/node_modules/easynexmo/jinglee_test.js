...
//var nexmo = new nexmoLib("0056f4c3","nexmoapi",true);
//nexmo.initialize("0056f4c3","nexmoapi",true);
nexmo.initialize("1234","abcd",true);
nexmo.setHost("httpbin.org");
nexmo.sendTextMessage("1234567890","1234567890",'acknowldge receipt by whatsapp - test',consolelog);
