(function() {
    ...
    angular.module('app.context')
        .factory('ContextService', ["$resource", "$cookies", "$location", "$state",
            function($resource, $cookies, $location, $state) {
                var contextService = {};
                ...
                contextService.items = function(route) {
                    var items = {
                        'page/admin/profile/:id': [{
                            ...
                            url: 'page/user/delete/' + id,
                            roles: ['admin']
                        }],
                        'page/course/profile/:id': [{
                                name: 'Disciplinas',
                                url: 'page/course/subjects/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Estudantes',
                                url: 'page/course/students/' + id,
                                roles: ['manager', 'professor']
                            }, {
                                name: 'todos os Cursos',
                                url: 'page/school/courses/' + id,
                                roles: ['manager', 'professor', 'admin']
                            },
                            //{name: 'Adicionar Horários', url: 'page/course/schedule/batch/'+id, roles: ['manager','professor','admin']},
                            {
                                name: 'Eliminar Curso',
                                url: 'page/course/delete/' + id,
                                roles: ['admin', 'manager']
                            }, {
                                name: 'Eliminar Disciplinas',
                                url: 'page/course/subject/delete/' + id,
                                roles: ['manager']
                            }, {
                                name: 'Eliminar Estudantes',
                                url: 'page/course/student/delete/' + id,
                                roles: ['manager']
                            }
                        ],
                        'page/course/subjects/:id': [{
                            name: 'Curso',
                            url: 'page/course/profile/' + id,
                            roles: ['manager', 'professor', 'admin']
                        }, {
                            name: 'Eliminar Disciplinas',
                            url: 'page/course/subject/delete/' + id,
                        ...
                        'page/professor/profile/:id': [
                            ...
                            {
                                name: 'Horários',
                                url: 'page/professor/schedules/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Eliminar Professor',
                                url: 'page/user/delete/' + id,
                                roles: ['manager']
                            }, {
                                name: 'Eliminar Horários',
                                url: 'page/professor/schedule/delete/' + id,
                                roles: ['manager']
                            }
                        ...
                        'page/school/courses/:id': [
                            //{name: 'Adicionar Cursos', url: 'page/school/course/batch/'+id, roles: ['manager']},
                            {
                                ...
                                url: 'page/school/course/delete/' + id,
                                roles: ['manager']
                            }
                        ],
                        'page/school/professors/:id': [
                            ...
                            {
                                name: 'Eliminar Professores',
                                url: 'page/school/professor/delete/' + id,
                                roles: ['manager']
                            }
                        ],
                        'page/school/profile/:id': [{
                                ...
                                name: 'Disciplinas',
                                url: 'page/school/subjects/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Estudantes',
                                url: 'page/school/students/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Professores',
                                url: 'page/school/professors/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Horários',
                                url: 'page/school/schedules/' + id,
                                roles: ['manager', 'professor', 'admin']
                            },
                            //{name: 'Adicionar Cursos', url: 'page/school/course/batch/'+id, roles: ['manager']},
                            ...
                            {
                                name: 'Eliminar Escola',
                                url: 'page/school/delete/' + id,
                                roles: ['admin']
                            }
                        ],
                        'page/school/schedules/:id': [{
                            name: 'Eliminar Horários',
                            url: 'page/school/schedule/delete/' + id,
                            roles: ['admin', 'manager']
                        }],
                        ...
                        'page/school/students/:id': [
                            ...
                            {
                                name: 'Eliminar Estudantes',
                                url: 'page/school/student/delete/' + id,
                                roles: ['manager']
                            }
                        ],
                        'page/school/subjects/:id': [
                            ...
                            {
                                name: 'Eliminar Disciplinas',
                                url: 'page/school/subject/delete/' + id,
                                roles: ['manager']
                            }
                        ],
                        ...
                        'page/subject/profile/:id': [
                            ...
                            {
                                name: 'Horários',
                                url: 'page/subject/schedules/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Estudantes',
                                url: 'page/subject/students/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Sessions',
                                url: 'page/subject/sessions/' + id,
                                roles: ['manager', 'professor', 'admin']
                            }, {
                                name: 'Eliminar Disciplina',
                                url: 'page/subject/delete/' + id,
                                roles: ['manager']
                            }, {
                                name: 'Eliminar Horários',
                                url: 'page/subject/schedule/delete/' + id,
                                roles: ['manager']
                            }
                        ],
